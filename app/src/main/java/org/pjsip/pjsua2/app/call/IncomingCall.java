...
public class IncomingCall implements Serializable, ICall {
    ...
    private SipCall.VOIP_CALL_STATE state;
    private long time;
     ...
     *
     * @return callState {@link SipCall.VOIP_CALL_STATE}
     */
    @Override
     ...
     *
     * @param connected {@link SipCall.VOIP_CALL_STATE}
     */
    @Override
     ...
     *
     * @param callType {@link SipServiceConstants.CALLTYPE}
     */
    @Override
     ...
     *
     * @return callType of incoming call {@link SipServiceConstants.CALLTYPE}
     */
    @Override
