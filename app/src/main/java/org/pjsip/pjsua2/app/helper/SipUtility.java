...
public class SipUtility {
    ...
    private static String getProtocolName(Context context) {
        ...
        return SharedPreferenceData.isSecureProtocol(context) ? secureProtocolName : protocolName;
    }
    ...
    private static int getPortNumber(Context context) {
        ...
        return SharedPreferenceData.isSecureProtocol(context) ? securedPort : port;
    }
